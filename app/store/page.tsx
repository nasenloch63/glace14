      ...
      <section className="min-h-[calc(100vh-80px)] flex items-center justify-center px-6 md:px-12 pt-32 pb-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-body-lg font-body text-muted-foreground leading-relaxed mb-8">
            We're currently focusing on refining our studio offerings and booking system. Our collection of limited edition prints and creative products will be available here soon. In the meantime, discover our studio spaces and book a session.
          </p>
